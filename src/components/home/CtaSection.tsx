      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          ...
          >
            <Link
              href="/signup"
              className="inline-flex items-center justify-center rounded-xl px-5 py-3 bg-gradient-to-r text-white font-medium shadow from-blue-600 to-emerald-500 hover:from-blue-700 hover:to-emerald-600"
            >
